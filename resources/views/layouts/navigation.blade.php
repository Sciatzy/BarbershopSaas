...
<aside class="w-[260px] flex-shrink-0 bg-[#FAFAFB] h-full flex flex-col overflow-y-auto overflow-x-hidden z-30 py-8 px-6 hidden lg:flex border-r border-gray-100">
    ...
    <nav class="flex flex-col gap-2 relative mb-auto">
        ...
        @if (Auth::user()->hasAnyRole(['Barbershop Admin', 'Branch Manager']))
            ...
            <a href="#" class="{{ $navItemClass }}">
                <svg class="{{ $iconClass }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                Transfers
            </a>
            ...
            <a href="#" class="{{ $navItemClass }}">
                <svg class="{{ $iconClass }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                Message
            </a>
            ...
            <a href="#" class="{{ $navItemClass }}">
                <svg class="{{ $iconClass }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                Favorite
            </a>
    ...
    <div class="mt-8 flex flex-col gap-1">
        ...
        <a href="#" class="{{ $navItemClass }}">
            <!-- Circle question mark for Support -->
            <svg class="{{ $iconClass }} rounded-full bg-gray-600 text-white" style="width:18px;height:18px;padding:2px;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3m.08 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            Support
        </a>
